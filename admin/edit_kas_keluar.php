...
$edit = mysqli_query($koneksi,"SELECT * from kas where kode='".$_GET["nmr"]."'");
$editDb = mysqli_fetch_assoc($edit);
	if($_POST["pasien"]){
			include_once("../library/koneksi.php");
			mysqli_query($koneksi,"UPDATE kas set  keterangan='".$_POST["nama"]."',  tgl='".$_POST["tgl"]."', keluar='".$_POST["usia"]."' where kode='".$_GET["nmr"]."'");
