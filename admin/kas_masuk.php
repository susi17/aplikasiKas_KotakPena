...
$max	 = ceil($jml/$row);
?>
<a href="?menu=tambah_kas" class="btn btn-primary btn-rect" style="background-color: #133337"><i class='icon icon-white icon-plus'></i> Tambah Kas Masuk</a><p>
<div class="panel panel-default" >
	<div class="panel-heading" style="background-color: #133337">
		<span style="color: white"> Manajemen Kas Masuk </span>
	</div>
